...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, GoogleMap.OnMarkerClickListener, LocationListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sensor1 = new LatLng(-34.915399, 138.599539);
        mMap.addMarker(new MarkerOptions().position(sensor1).title("Sensor1 Location"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(sensor1));
        mMap.getUiSettings().setZoomControlsEnabled(true);
        mMap.setOnMarkerClickListener(this);

        LatLng sensor2 = new LatLng(-34.909348, 138.608164);
        mMap.addMarker(new MarkerOptions().position(sensor2).title("Sensor2 Location"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(sensor2));
    }
